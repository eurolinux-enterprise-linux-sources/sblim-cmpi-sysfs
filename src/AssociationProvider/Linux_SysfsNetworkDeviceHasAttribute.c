/* ---------------------------------------------------------------------------
 * Linux_SysfsNetworkDeviceHasAttribute.c
 *
 ...
 * Description: Association provider for Linux_SysfsNetworkDevice class.
 * 		Associates a Linux_SysfsNetworkDevice instance with its respective
...
static const char * _CLASSNAME = "Linux_SysfsNetworkDeviceHasAttribute";
static char * _SOURCECLASSNAME = "Linux_SysfsNetworkDevice";
 ...
 * AssociatorNames
 */
CMPIStatus Linux_SysfsNetworkDeviceHasAttributeAssociatorNames(
		...
		const char * resultRole )
{
   ...
   /* Check that the reference object is of Linux_SysfsNetworkDevice */
 ...
 * Associators
 */
CMPIStatus Linux_SysfsNetworkDeviceHasAttributeAssociators(
		CMPIAssociationMI * mi,
		const CMPIContext * context, 
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * ReferenceNames
 */
CMPIStatus Linux_SysfsNetworkDeviceHasAttributeReferenceNames(
		CMPIAssociationMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * References
 */
CMPIStatus Linux_SysfsNetworkDeviceHasAttributeReferences(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsNetworkDeviceHasAttributeAssociationCleanup(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
 ...
 * Factory methods
 */
CMAssociationMIStub( Linux_SysfsNetworkDeviceHasAttribute,
      	     Linux_SysfsNetworkDeviceHasAttribute,
	     _broker,
	     CMNoHook);
