/* ---------------------------------------------------------------------------
 * Linux_SysfsSCSIHostDeviceHasAttribute.c
 *
 ...
 * Description: Association provider for Linux_SysfsSCSIHostDevice class.
 * 		Associates a Linux_SysfsSCSIHostDevice instance with its respective
...
static const char * _CLASSNAME = "Linux_SysfsSCSIHostDeviceHasAttribute";
static char * _SOURCECLASSNAME = "Linux_SysfsSCSIHostDevice";
 ...
 * AssociatorNames
 */
CMPIStatus Linux_SysfsSCSIHostDeviceHasAttributeAssociatorNames(
		...
		const char * resultRole )
{
   ...
   /* Check that the reference object is of Linux_SysfsSCSIHostDevice */
 ...
 * Associators
 */
CMPIStatus Linux_SysfsSCSIHostDeviceHasAttributeAssociators(
		CMPIAssociationMI * mi,
		const CMPIContext * context, 
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * ReferenceNames
 */
CMPIStatus Linux_SysfsSCSIHostDeviceHasAttributeReferenceNames(
		CMPIAssociationMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * References
 */
CMPIStatus Linux_SysfsSCSIHostDeviceHasAttributeReferences(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsSCSIHostDeviceHasAttributeAssociationCleanup(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
 ...
 * Factory methods
 */
CMAssociationMIStub( Linux_SysfsSCSIHostDeviceHasAttribute,
      	     Linux_SysfsSCSIHostDeviceHasAttribute,
	     _broker,
	     CMNoHook);
