/* ---------------------------------------------------------------------------
 * Linux_SysfsBusDeviceHasAttribute.c
 *
 ...
 * Description: Association provider for Linux_SysfsBusDevice class.
 * 		Associates a Linux_SysfsBusDevice instance with its respective
...
static const char * _CLASSNAME = "Linux_SysfsBusDeviceHasAttribute";
static char * _SOURCECLASSNAME = "Linux_SysfsBusDevice";
 ...
 * AssociatorNames
 */
CMPIStatus Linux_SysfsBusDeviceHasAttributeAssociatorNames(
		...
		const char * resultRole )
{
   ...
   /* Check that the reference object is of Linux_SysfsBusDevice */
 ...
 * Associators
 */
CMPIStatus Linux_SysfsBusDeviceHasAttributeAssociators(
		CMPIAssociationMI * mi,
		const CMPIContext * context, 
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * ReferenceNames
 */
CMPIStatus Linux_SysfsBusDeviceHasAttributeReferenceNames(
		CMPIAssociationMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * References
 */
CMPIStatus Linux_SysfsBusDeviceHasAttributeReferences(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsBusDeviceHasAttributeAssociationCleanup(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
 ...
 * Factory methods
 */
CMAssociationMIStub( Linux_SysfsBusDeviceHasAttribute,
      	     Linux_SysfsBusDeviceHasAttribute,
	     _broker,
	     CMNoHook);
