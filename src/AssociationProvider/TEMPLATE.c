 ...
 * Description: Association provider for $CLASSNAME class.
 * 		Associates a $CLASSNAME instance with its respective
...
static const char * _CLASSNAME = "$CLASSNAMEHasAttribute";
static char * _SOURCECLASSNAME = "$CLASSNAME";
 ...
 * AssociatorNames
 */
CMPIStatus $CLASSNAMEHasAttributeAssociatorNames(
		...
		const char * resultRole )
{
   ...
   /* Check that the reference object is of $CLASSNAME */
 ...
 * Associators
 */
CMPIStatus $CLASSNAMEHasAttributeAssociators(
		CMPIAssociationMI * mi,
		const CMPIContext * context, 
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * ReferenceNames
 */
CMPIStatus $CLASSNAMEHasAttributeReferenceNames(
		CMPIAssociationMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * References
 */
CMPIStatus $CLASSNAMEHasAttributeReferences(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * Cleanup
 */
CMPIStatus $CLASSNAMEHasAttributeAssociationCleanup(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
 ...
 * Factory methods
 */
CMAssociationMIStub( $CLASSNAMEHasAttribute,
      	     $CLASSNAMEHasAttribute,
	     _broker,
	     CMNoHook);
