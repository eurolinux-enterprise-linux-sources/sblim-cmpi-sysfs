/* ---------------------------------------------------------------------------
 * Linux_SysfsSCSIDeviceHasAttribute.c
 *
 ...
 * Description: Association provider for Linux_SysfsSCSIDevice class.
 * 		Associates a Linux_SysfsSCSIDevice instance with its respective
...
static const char * _CLASSNAME = "Linux_SysfsSCSIDeviceHasAttribute";
static char * _SOURCECLASSNAME = "Linux_SysfsSCSIDevice";
 ...
 * AssociatorNames
 */
CMPIStatus Linux_SysfsSCSIDeviceHasAttributeAssociatorNames(
		...
		const char * resultRole )
{
   ...
   /* Check that the reference object is of Linux_SysfsSCSIDevice */
 ...
 * Associators
 */
CMPIStatus Linux_SysfsSCSIDeviceHasAttributeAssociators(
		CMPIAssociationMI * mi,
		const CMPIContext * context, 
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * ReferenceNames
 */
CMPIStatus Linux_SysfsSCSIDeviceHasAttributeReferenceNames(
		CMPIAssociationMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * References
 */
CMPIStatus Linux_SysfsSCSIDeviceHasAttributeReferences(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsSCSIDeviceHasAttributeAssociationCleanup(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
 ...
 * Factory methods
 */
CMAssociationMIStub( Linux_SysfsSCSIDeviceHasAttribute,
      	     Linux_SysfsSCSIDeviceHasAttribute,
	     _broker,
	     CMNoHook);
