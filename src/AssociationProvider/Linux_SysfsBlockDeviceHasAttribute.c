/* ---------------------------------------------------------------------------
 * Linux_SysfsBlockDeviceHasAttribute.c
 *
 ...
 * Description: Association provider for Linux_SysfsBlockDevice class.
 * 		Associates a Linux_SysfsBlockDevice instance with its respective
...
static const char * _CLASSNAME = "Linux_SysfsBlockDeviceHasAttribute";
static char * _SOURCECLASSNAME = "Linux_SysfsBlockDevice";
 ...
 * AssociatorNames
 */
CMPIStatus Linux_SysfsBlockDeviceHasAttributeAssociatorNames(
		...
		const char * resultRole )
{
   ...
   /* Check that the reference object is of Linux_SysfsBlockDevice */
 ...
 * Associators
 */
CMPIStatus Linux_SysfsBlockDeviceHasAttributeAssociators(
		CMPIAssociationMI * mi,
		const CMPIContext * context, 
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * ReferenceNames
 */
CMPIStatus Linux_SysfsBlockDeviceHasAttributeReferenceNames(
		CMPIAssociationMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * References
 */
CMPIStatus Linux_SysfsBlockDeviceHasAttributeReferences(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
		const CMPIResult * results,
		const CMPIObjectPath * reference,
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsBlockDeviceHasAttributeAssociationCleanup(
		CMPIAssociationMI * mi,
		const CMPIContext * context,
 ...
 * Factory methods
 */
CMAssociationMIStub( Linux_SysfsBlockDeviceHasAttribute,
      	     Linux_SysfsBlockDeviceHasAttribute,
	     _broker,
	     CMNoHook);
