 ...
 * Description:	Instance provider for Linux_SysfsSCSIDevice class
...
static const char * _CLASSNAME = "Linux_SysfsSCSIDevice";
static char * _LOCATION = "/sys/class/scsi_device";
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_SysfsSCSIDeviceEnumInstanceNames(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_SysfsSCSIDeviceEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * GetInstance
 */
CMPIStatus Linux_SysfsSCSIDeviceGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * SetInstance
 */
CMPIStatus Linux_SysfsSCSIDeviceSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference,
 ...
 * CreateInstance
 */
CMPIStatus Linux_SysfsSCSIDeviceCreateInstance(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_SysfsSCSIDeviceDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_SysfsSCSIDeviceExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsSCSIDeviceCleanup(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
 ...
 * Factory methods
 */
CMInstanceMIStub( Linux_SysfsSCSIDevice,
		  Linux_SysfsSCSIDevice,
		  _broker,
		  CMNoHook);
