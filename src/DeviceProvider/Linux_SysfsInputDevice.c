 ...
 * Description:	Instance provider for Linux_SysfsInputDevice class
...
static const char * _CLASSNAME = "Linux_SysfsInputDevice";
static char * _LOCATION = "/sys/class/input";
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_SysfsInputDeviceEnumInstanceNames(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_SysfsInputDeviceEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * GetInstance
 */
CMPIStatus Linux_SysfsInputDeviceGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * SetInstance
 */
CMPIStatus Linux_SysfsInputDeviceSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference,
 ...
 * CreateInstance
 */
CMPIStatus Linux_SysfsInputDeviceCreateInstance(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_SysfsInputDeviceDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_SysfsInputDeviceExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsInputDeviceCleanup(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
 ...
 * Factory methods
 */
CMInstanceMIStub( Linux_SysfsInputDevice,
		  Linux_SysfsInputDevice,
		  _broker,
		  CMNoHook);
