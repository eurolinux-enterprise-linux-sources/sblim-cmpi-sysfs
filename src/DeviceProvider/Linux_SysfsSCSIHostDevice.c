 ...
 * Description:	Instance provider for Linux_SysfsSCSIHostDevice class
...
static const char * _CLASSNAME = "Linux_SysfsSCSIHostDevice";
static char * _LOCATION = "/sys/class/scsi_host";
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_SysfsSCSIHostDeviceEnumInstanceNames(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_SysfsSCSIHostDeviceEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * GetInstance
 */
CMPIStatus Linux_SysfsSCSIHostDeviceGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * SetInstance
 */
CMPIStatus Linux_SysfsSCSIHostDeviceSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference,
 ...
 * CreateInstance
 */
CMPIStatus Linux_SysfsSCSIHostDeviceCreateInstance(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_SysfsSCSIHostDeviceDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_SysfsSCSIHostDeviceExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsSCSIHostDeviceCleanup(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
 ...
 * Factory methods
 */
CMInstanceMIStub( Linux_SysfsSCSIHostDevice,
		  Linux_SysfsSCSIHostDevice,
		  _broker,
		  CMNoHook);
