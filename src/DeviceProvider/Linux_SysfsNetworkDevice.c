 ...
 * Description:	Instance provider for Linux_SysfsNetworkDevice class
...
static const char * _CLASSNAME = "Linux_SysfsNetworkDevice";
static char * _LOCATION = "/sys/class/net";
 ...
 * EnumInstanceNames
 */
CMPIStatus Linux_SysfsNetworkDeviceEnumInstanceNames(
		CMPIInstanceMI * mi, 
 ...
 * EnumInstances
 */
CMPIStatus Linux_SysfsNetworkDeviceEnumInstances(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * GetInstance
 */
CMPIStatus Linux_SysfsNetworkDeviceGetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * SetInstance
 */
CMPIStatus Linux_SysfsNetworkDeviceSetInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference,
 ...
 * CreateInstance
 */
CMPIStatus Linux_SysfsNetworkDeviceCreateInstance(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
                const CMPIResult * results,
                const CMPIObjectPath * reference,
 ...
 * DeleteInstance
 */
CMPIStatus Linux_SysfsNetworkDeviceDeleteInstance(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference) 
 ...
 * ExecQuery
 */
CMPIStatus Linux_SysfsNetworkDeviceExecQuery(
		CMPIInstanceMI * mi, 
		const CMPIContext * context, 
		const CMPIResult * results, 
		const CMPIObjectPath * reference, 
 ...
 * Cleanup
 */
CMPIStatus Linux_SysfsNetworkDeviceCleanup(
                CMPIInstanceMI * mi,
                const CMPIContext * context,
 ...
 * Factory methods
 */
CMInstanceMIStub( Linux_SysfsNetworkDevice,
